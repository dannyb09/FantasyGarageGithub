...
IL_0022:
	{
		...
		NullCheck(L_5);
		VirtActionInvoker2< bool, bool >::Invoke(104 /* System.Void TMPro.TMP_Text::ForceMeshUpdate(System.Boolean,System.Boolean) */, L_5, (bool)0, (bool)0);
...
IL_04a0:
	{
		...
		int32_t L_264 = V_13;
		NullCheck(L_259);
		VirtActionInvoker2< Mesh_t2F5992DBA650D5862B43D3823ACD997132A57DA6 *, int32_t >::Invoke(105 /* System.Void TMPro.TMP_Text::UpdateGeometry(UnityEngine.Mesh,System.Int32) */, L_259, L_263, L_264);
		// for (int i = 0; i < textInfo.meshInfo.Length; i++)
		int32_t L_265 = V_13;
...
IL_0446:
	...
	}
	{
		...
		NullCheck(L_212);
		VirtActionInvoker0::Invoke(107 /* System.Void TMPro.TMP_Text::UpdateVertexData() */, L_212);
